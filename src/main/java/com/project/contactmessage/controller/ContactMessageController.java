...
public class ContactMessageController {
    ...
    @PostMapping("/save") // http://localhost:8081/contactMessages/save + POST + JSON
    ...
    @GetMapping("/getAll") // http://localhost:8081/contactMessages/getAll + GET
    ...
    @GetMapping("/searchByEmail")  // http://localhost:8081/contactMessages/searchByEmail?email=aaa@bbb.com  + GET
    ...
    @GetMapping("/searchBySubject")// http://localhost:8081/contactMessages/searchBySubject?subject=deneme
    ...
    @DeleteMapping("/deleteById/{contactMessageId}") // http://localhost:8081/contactMessages/deleteById/2 + DELETE
    ...
    @DeleteMapping("/deleteByIdParam")  //http://localhost:8081/contactMessages/deleteByIdParam?contactMessageId=2
    ...
    @GetMapping("/searchBetweenDates")  //http://localhost:8081/contactMessages/searchBetweenDates?beginDate=2023-09-13&endDate=2023-09-15   + GET
    ...
    @GetMapping("/searchBetweenTimes")//http://localhost:8081/contactMessages/searchBetweenTimes?startHour=09&startMinute=00&endHour=17&endMinute=30  + GET
    ...
    @GetMapping("/getByIdParam")//http://localhost:8081/contactMessages/getByIdParam?contactMessageId=1  + GET
