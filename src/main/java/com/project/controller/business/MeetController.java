...
public class MeetController {
    ...
    @PostMapping("/save") // http://localhost:8081/meet/save + POST + JSON
    public ResponseMessage<MeetResponse> saveMeet(@RequestBody @Valid MeetRequest meetRequest, HttpServletRequest httpServletRequest) {
        return meetService.saveMeet((HttpServletRequest) meetRequest, (MeetRequest) httpServletRequest);
    }

    // Not: ( ODEVV ) update ******************************************
    @PreAuthorize("hasAnyAuthority('ADMIN','TEACHER')")
    @PutMapping("/update/{meetId}") //http://localhost:8081/meet/update/1
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    @GetMapping("/getMeetById/{meetId}")  // http://localhost:8081/meet/getMeetById/1
    public ResponseMessage<MeetResponse> getMeetById(@PathVariable Long meetId) {
        return meetService.getMeetById(meetId);
    }

    @PreAuthorize("hasAnyAuthority('TEACHER','ADMIN' )")
    @DeleteMapping("/delete/{meetId}") // http://localhost:8081/meet/2
    ...
    @PreAuthorize("hasAnyAuthority('TEACHER')")
    @GetMapping("/getAllMeetByAdvisorTeacherAsList") // http://localhost:8081/meet//getAllMeetByAdvisorTeacherAsList
    ...
    @GetMapping("/getAllMeetByStudent") // http://localhost:8081/meet/getAllMeetByStudent
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    @GetMapping("/getAllMeetByPage") // http://localhost:8081/meet/getAllMeetByPage
    ...
    @PreAuthorize("hasAnyAuthority('TEACHER')")
    @GetMapping("/getAllMeetByAdvisorTeacherAsPage") // http://localhost:8081/meet/getAllMeetByAdvisorTeacherAsPage
