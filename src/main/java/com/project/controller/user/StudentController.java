...
public class StudentController {
    ...
    @PostMapping("/save") // http://localhost:8081/student/save + JSON + POST
    ...
    @PatchMapping("/update")   // http://localhost:8081/user/updateStudent
    ...
    // Not: updateStudent() **********************************************************
    @PutMapping("/update/{userId}")   // http://localhost:8081/user/update/2
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    @GetMapping("/changeStatus") // http://localhost:8081/student/changeStatus?id=1&status=true
    ...
    @PreAuthorize("hasAnyAuthority('STUDENT')")
    @PostMapping("/addLessonProgramToStudent") // http://localhost:8081/student/addLessonProgramToStudent
