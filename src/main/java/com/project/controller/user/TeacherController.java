...
public class TeacherController {
    ...
    @PostMapping("/save") // http://localhost:8081/teacher/save + JSON + POST
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    @PatchMapping("/saveAdvisorTeacher/{teacherId}") // http://localhost:8081/teacher/saveAdvisorTeacher/1
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    @DeleteMapping("/deleteAdvisorTeacherById/{id}")// http://localhost:8081/teacher/deleteAdvisorTeacherById/1
    ...
    @GetMapping("/getAllStudentByAdvisorUsername") // http://localhost:8081/teacher/getAllStudentByAdvisorUsername
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    @GetMapping("/getAllAdvisorTeacher") // http://localhost:8081/teacher/getAllAdvisorTeacher
    ...
    // TODO: LESSOn PROGRAM ekleme
      @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    @PostMapping("/addLessonProgram")  // http://localhost:8081/teacher/addLessonProgram
